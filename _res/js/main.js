(_ => {
	const isMobile = _ => {
		...
		document.documentElement.classList[window.innerHeight > window.innerWidth ? "add" : "remove"]("portrait");
		return isM;
	};
	isMobile();
